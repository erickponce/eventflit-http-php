...
class EventflitAuthQueryString extends PHPUnit_Framework_TestCase
{
    ...
    public function testArrayImplode()
    {
        ...
        $actual = Eventflit\Eventflit::array_implode('=', '&', $val);
    ...
    public function testGenerateSignature()
    {
        ...
        $auth_query_string = Eventflit\Eventflit::build_auth_query_string(
            $auth_key,
            $auth_secret,
            $method,
            $request_path,
